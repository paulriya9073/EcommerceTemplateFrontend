          ...
          <div className="relative">
            ...
            <FaArrowLeft/>
                ...
                <div className={`md:col-span-10 h-full ${sidebarOpen ? 'hidden md:block' : 'col-span-12'}`}>
                    ...
                    <div className='h-auto pb-8 w-full flex flex-col justify-center items-center '>
                        <div className='flex flex-col bg-white shadow-md pb-8 justify-center items-center rounded-md mb-4 p-2 gap-4 md:p-8 md:gap-8'>
                            ...
                            <div className='flex flex-col gap-2 md:gap-4 md:w-full md:h-28 px-3'>
                                ...
                                <div className='flex flex-row items-center gap-4'>
                                    <input className='md:text-2xl border-blue-400 border rounded-lg bg-blue-50 w-80 md:w-[55vw] p-2'
                                        type="text"
                                        value={username}
                                    ...
                                    {isEditingUsername ? (
                                        ...
                                        <div className='flex '>
                                            <button className='w-9 h-5 md:w-12 md:h-7 text-[.8rem] md:text-[1rem] rounded text-white  bg-blue-500 mr-3' onClick={handleaUpdateProfile}> Save</button>

                                            <button className='w-12 h-5 md:w-16 md:h-7 text-[.8rem] md:text-[1rem]  rounded text-white  bg-red-500' onClick={cancelHandler}>Cancel</button>
                                        </div>
                                    ) :
                                        (
                                            <button className='w-8 h-5 md:w-10 md:h-7 rounded text-[.8rem] md:text-[1rem] text-white  bg-blue-500' onClick={() => handleEdit('username')}> Edit</button>
                            ...
                            <div className='flex flex-col gap-2 md:gap-4 md:w-full md:h-28 px-3'>
                                ...
                                <div className='flex flex-row items-center gap-4'>
                                    ...
                                    {isEditingEmail ? (
                                        ...
                                        (
                                            <button className='w-8 h-5 md:w-10 md:h-7 text-[.8rem] md:text-[1rem] rounded text-white  bg-blue-500' onClick={() => handleEdit("email")}> Edit</button>
                            ...
                            <div className='flex flex-col gap-2 md:gap-4 md:w-full md:h-28 px-3'>
                                ...
                                <div className='flex flex-row items-center gap-4'>
                                    ...
                                    {isEditingPhone ? (
                                        ...
                                        (
                                            <button className='w-8 h-5 md:w-10 md:h-7 text-[.8rem] md:text-[1rem] rounded text-white  bg-blue-500' onClick={() => handleEdit("phone")}> Edit</button>
                            ...
                            <div className='flex flex-col gap-2 md:gap-4 md:w-full md:h-28 px-3'>
                                ...
                                <div className='flex flex-row gap-4 w-full'>
                                    ...
                                    {isEditingGender ? (
                                        ...
                                        (
                                            <button className='w-8 h-5 md:w-10 md:h-7 ml-5 text-[.8rem] md:text-[1rem] rounded text-white  bg-blue-500' onClick={() => handleEdit("gender")}> Edit</button>
