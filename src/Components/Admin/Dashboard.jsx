    ...
    <>
      <div className='w-full h-full'>
        ...
        <div className="flex flex-col w-full justify-evenly items-center gap-8 p-4 md:p-8 bg-blue-50 overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row w-full justify-evenly items-center gap-8 p-2 md:p-8 bg-blue-50">
          ...
          <div className="flex flex-col lg:flex-row w-full justify-evenly items-center gap-8 p-4 md:p-8">
